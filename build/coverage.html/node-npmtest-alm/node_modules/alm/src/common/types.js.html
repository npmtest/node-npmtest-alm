...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-alm/node_modules/alm/src/common/types.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-alm/node_modules/alm/src/common/types.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85.54% <small>(71 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">85.54% <small>(71 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-alm/node_modules/alm/src/common/</a> &#187; types.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function getRefactoringsByFilePath(refactorings) {</span>
<span class="cstat-no" title="statement not covered" >    var loc = {};</span>
<span class="cstat-no" title="statement not covered" >    for (var _i = 0, refactorings_1 = refactorings; _i &lt; refactorings_1.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >        var refac = refactorings_1[_i];</span>
<span class="cstat-no" title="statement not covered" >        if (!loc[refac.filePath])</span>
<span class="cstat-no" title="statement not covered" >            loc[refac.filePath] = [];</span>
<span class="cstat-no" title="statement not covered" >        loc[refac.filePath].push(refac);</span>
    }
    // sort each of these in descending by start location
<span class="cstat-no" title="statement not covered" >    for (var filePath in loc) {</span>
<span class="cstat-no" title="statement not covered" >        var refactorings_2 = loc[filePath];</span>
<span class="cstat-no" title="statement not covered" >        refactorings_2.sort(<span class="fstat-no" title="function not covered" >function (a, b) {</span></span>
<span class="cstat-no" title="statement not covered" >            return (b.span.start - a.span.start);</span>
        });
    }
<span class="cstat-no" title="statement not covered" >    return loc;</span>
}
...
<span class="fstat-no" title="function not covered" >function makeBlandError(filePath, error, source) {</span>
