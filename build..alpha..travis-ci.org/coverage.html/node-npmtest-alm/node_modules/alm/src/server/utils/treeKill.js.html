...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-alm/node_modules/alm/src/server/utils/treeKill.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-alm/node_modules/alm/src/server/utils/treeKill.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-alm/node_modules/alm/src/server/utils/</a> &#187; treeKill.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function kill(pid, signal) {</span>
<span class="cstat-no" title="statement not covered" >    if (signal === void 0) { <span class="cstat-no" title="statement not covered" >signal = 'SIGTERM'; </span>}</span>
<span class="cstat-no" title="statement not covered" >    var resolve;</span>
<span class="cstat-no" title="statement not covered" >    var res = new Promise(<span class="fstat-no" title="function not covered" >function (res) {</span> <span class="cstat-no" title="statement not covered" >return resolve = res; </span>});</span>
...
<span class="cstat-no" title="statement not covered" >    switch (process.platform) {</span>
        case 'win32':
<span class="cstat-no" title="statement not covered" >            exec('taskkill /pid ' + pid + ' /T /F', resolve);</span>
...
<span class="cstat-no" title="statement not covered" >                killAll(tree, signal, resolve);</span>
            });
<span class="cstat-no" title="statement not covered" >            break;</span>
        default:
<span class="cstat-no" title="statement not covered" >            buildProcessTree(pid, tree, pidsToProcess, <span class="fstat-no" title="function not covered" >function (parentPid) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        allData.match(/\d+/g).forEach(<span class="fstat-no" title="function not covered" >function (_pid) {</span></span>
<span class="cstat-no" title="statement not covered" >            var pid = parseInt(_pid, 10);</span>
