...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-alm/node_modules/alm/src/common/json.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-alm/node_modules/alm/src/common/json.js</span></h1>
    <h2>
        
        Statements: <span class="metric">43.02% <small>(77 / 179)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">27.47% <small>(25 / 91)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">60% <small>(12 / 20)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">42.94% <small>(76 / 177)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-alm/node_modules/alm/src/common/</a> &#187; json.js</div>
</div>
<div class="body">
...
function parse(str) {
    ...
    var filteredLines = lines.map(function (x) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (x.trim().startsWith('//')) {
...
<span class="cstat-no" title="statement not covered" >        var indexToPosition = <span class="fstat-no" title="function not covered" >function (index) {</span></span>
<span class="cstat-no" title="statement not covered" >            var beforeLines = splitlines(content.substr(0, index));</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
                line: Math.max(beforeLines.length - 1, 0),
                ch: Math.max(beforeLines[beforeLines.length - 1].length - 1, 0)
            };
        };
<span class="cstat-no" title="statement not covered" >        var fromIndex = Math.max(error.at - 1, 0);</span>
<span class="cstat-no" title="statement not covered" >        var toIndex = Math.min(error.at + 1, content.length);</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
            error: {
                message: e.message,
...
exports.parse = parse;
<span class="fstat-no" title="function not covered" >function stringify(object, eol) {</span>
<span class="cstat-no" title="statement not covered" >    if (eol === void 0) { <span class="cstat-no" title="statement not covered" >eol = '\n'; </span>}</span>
<span class="cstat-no" title="statement not covered" >    var cache = [];</span>
<span class="cstat-no" title="statement not covered" >    var value = JSON.stringify(object, </span>
...
<span class="fstat-no" title="function not covered" >function parseErrorToCodeError(filePath, error, source) {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
        source: source,
        filePath: filePath,
        from: error.from,
...
function stripBOM(str) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof str === 'string' &amp;&amp; str.charCodeAt(0) === 0xFEFF) {
...
var json_parse = (function () {
    ...
    escapee = {
        ...
        r: '\r',
        t: '\t'
    }, text, error = <span class="fstat-no" title="function not covered" >function (m) {</span>
...
<span class="cstat-no" title="statement not covered" >        var number, string = '';</span>
...
<span class="cstat-no" title="statement not covered" >                return object; </span>// empty object
            ...
            while (ch) {
                ...
                white();
                next(':');
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwnProperty.call(object, key)) {
...
<span class="cstat-no" title="statement not covered" >            error("Syntax error");</span>
        ...
        return typeof reviver === 'function'
            ? (<span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >function walk(holder, key) {</span></span>
