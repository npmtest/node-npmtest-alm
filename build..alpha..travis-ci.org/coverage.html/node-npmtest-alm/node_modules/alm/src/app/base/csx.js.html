...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-alm/node_modules/alm/src/app/base/csx.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-alm/node_modules/alm/src/app/base/csx.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85.86% <small>(85 / 99)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">85.86% <small>(85 / 99)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-alm/node_modules/alm/src/app/base/</a> &#187; csx.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            throw new Error("User error: use extend(a,b) instead of extend([a,b]). Object: " + obj);</span>
        }
    }
    var newObj = {};
...
var Box;
(function (Box) {
<span class="fstat-no" title="function not covered" >    function boxUnitToString(value) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof value === 'number') {</span>
<span class="cstat-no" title="statement not covered" >            return value.toString() + 'px';</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            return value;</span>
    ...
    function createBoxFunction(mapFromBox) {
        var result = <span class="fstat-no" title="function not covered" >function (a, b, c, d) {</span>
<span class="cstat-no" title="statement not covered" >            if (b === undefined &amp;&amp; c === undefined &amp;&amp; d === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                b = c = d = a;</span>
            }
            else <span class="cstat-no" title="statement not covered" >if (c === undefined &amp;&amp; d === undefined) {</span>
...
<span class="cstat-no" title="statement not covered" >            return mapFromBox(box);</span>
        };
        return result;
    }
    Box.padding = createBoxFunction(<span class="fstat-no" title="function not covered" >function (box) {</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
    ...
    Box.margin = createBoxFunction(<span class="fstat-no" title="function not covered" >function (box) {</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
            marginTop: box.top,
    ...
    Box.border = createBoxFunction(<span class="fstat-no" title="function not covered" >function (box) {</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
            borderTop: box.top,
